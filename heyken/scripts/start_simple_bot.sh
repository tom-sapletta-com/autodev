#!/bin/bash
# Skrypt do uruchomienia prostego bota Heyken
...
echo -e "${GREEN}=================================================${NC}"
echo -e "${GREEN}         URUCHAMIANIE PROSTEGO BOTA HEYKEN       ${NC}"
echo -e "${GREEN}=================================================${NC}"
...
# Uruchom bota
echo -e "${YELLOW}Uruchamianie prostego bota...${NC}"
node simple_bot.js

echo -e "${GREEN}=================================================${NC}"
echo -e "${GREEN}         PROSTY BOT HEYKEN URUCHOMIONY           ${NC}"
echo -e "${GREEN}=================================================${NC}"
